...
<head>
<meta charset="UTF-8">
<title>ArtWorld User Registration</title>
...
<h1>Sign Up</h1>
<form class="formId" action="docsignup.php" method="POST">
...
<div id="btn">
<input type="submit" name="docsubmit">
</div>

<div class="extra">
<p>Already have an account? <button class="sexy-btn"><a href="doclogin.php">Log In</a></button></p>
</div>
</div>
